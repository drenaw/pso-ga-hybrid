function fitness = getFitness(noofStages,noofOriginalJobs,noofMachines,position,maxMachines,p,e,lambda,ps)
...
%fitness = lambda*fitness + (1-lambda)*sum(sum(e(:,:,ps)));
end
